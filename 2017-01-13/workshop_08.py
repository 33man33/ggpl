...
def build_ladder(filel, factorx, buildl):
	...
	@param filel: String represent the name of the file to read.
	@param factorx: Float represent a value for calculate the height of the ladder.
	@param buildl: Module for invoke the function that build a ladder.
...
def build_concrete_objects(fileo, offset, factorx, type, externalWalls, fwindows, fdoors): 
	...
	@param fileo: String represent the name of the file to read.
	@param offset: Integer represent the offset of the external walls or internal walls.
	@param factorx: Float represent a value for calculate the height of the window or the door.
	...
	@param fwindows: Function that generate a HPC Model represent the window.
	@param fdoors: Function that generate a HPC Model represent the door.
